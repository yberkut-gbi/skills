...
5. **Run `fe-check-setup`** to confirm the Atlassian MCP is reachable and the setup is green. Then tell the user setup is complete and which skills now read these files.
