...
## How to run it
- Work from the PRD/plan in context. If given an issue/Jira reference, fetch it first (Atlassian `getJiraIssue` — tool map in `core-setup`/MCP-SETUP.md) and read its full body + comments.
