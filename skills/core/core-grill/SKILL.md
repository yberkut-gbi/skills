...
## Know when to stop
Stop at shared understanding — alignment, not interrogation for its own sake. When the open branches are resolved and the terms are clean, hand to `pm-to-prd` (write it up) or straight to `fe-tdd`.
